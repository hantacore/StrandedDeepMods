    ...
    public class JellyfishParticleSystem : MonoBehaviour
    {
        ...
        void Start()
        {
            try
            {
                ...
                mm.startSpeed = new ParticleSystem.MinMaxCurve(0.05f, 0.2f);//50;
                mm.startSize = new ParticleSystem.MinMaxCurve(0.05f, 0.2f);// 10;
                mm.startRotation = new ParticleSystem.MinMaxCurve(-20.0F * Mathf.Deg2Rad, 20.0F * Mathf.Deg2Rad);//works, flips the sprite;
                mm.simulationSpeed = 0.05f;
                ...
                nm.enabled = true;
                nm.strength = new ParticleSystem.MinMaxCurve(0.5f, 2.5f);
                nm.frequency = 0.6f;
                nm.damping = true;
                nm.octaveCount = 1;
                ...
                try
                {
                    ...
                    mat.SetTexture("_MainTex", Main._indexedTextures["StrandedDeepLODMod.assets.Textures.jellyfish.png"]);
