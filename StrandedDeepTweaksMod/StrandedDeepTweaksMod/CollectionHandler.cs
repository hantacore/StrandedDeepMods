...
namespace StrandedDeepTweaksMod
{
    public class CollectionHandler<T>
    {
        ...
        public void FillQueue(T[] collection)
        {
            ...
            {
                Debug.Log("Stranded Deep Tweaks Mod : FillQueue failed : " + e);
            }
        }
        ...
        public void Handle()
        {
            try
            {
                ...
                try
                {
                        ...
                        && sw.ElapsedMilliseconds <= MaxMilliseconds)
                    {
                        ...
                        {
                            Debug.Log("Stranded Deep Tweaks Mod : Handle failed for " + element.ToString() + " : " + e);
                        }
                        finally
                        {
                ...
                {
                    Debug.Log("Stranded Deep Tweaks Mod : Handle failed (1) " + e);
                }
                finally
                {
                    sw.Stop();
            ...
            {
                Debug.Log("Stranded Deep Tweaks Mod : Handle failed (2) " + e);
            }
        }
