// Stranded deep Mapper by Hantacore - v0.16 / 0.72 big world compatibility
var debug = false;
var dragging = false;
var lastX;
var lastY;
...
// ROCKS
let imageRock = initImage('./icons/rock.png', 50000);
let imageRockDraw = initImage('./icons/rock_draw.png', 50000);

// TREES
let imagePalm = initImage('./icons/palmtree.png', 20000);
let imagePalmDraw = initImage('./icons/plant.png', 20000);
let imagePlant = initImage('./icons/palmtree.png', 20000);
