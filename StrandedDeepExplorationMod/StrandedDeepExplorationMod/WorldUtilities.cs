    ...
    public static class WorldUtilities
    {
        ...
        public static bool IsWorldLoaded()
        {
                ...
                || Beam.Game.State == GameState.LOAD_GAME)
            {
                ...
                {
                    Debug.Log("Stranded Deep Exploration Mod : world instance changed, clearing events");
                ...
                {
                    Debug.Log("Stranded Deep Exploration Mod : world instance found, registering events");
        ...
        {
            Debug.Log("Stranded Deep Exploration Mod : World Loaded event");
            worldLoaded = true;
        }
    }
}
